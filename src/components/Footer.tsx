...
export default function (props: any) {
    return (
        <footer className={`grid grid-cols-12 bg-indigo-50 xl:pt-10 `}>
            <section className='flex flex-col xl:flex-row items-center md:items-start font-medium p-8 xl:pl-36 gap-4 xl:gap-24 md:col-span-5 col-span-12'>
            ...
            <section className='md:col-span-7 col-span-12 flex flex-col gap-2 pt-10 pr-8 xl:pr-36 xl:pb-20'>
